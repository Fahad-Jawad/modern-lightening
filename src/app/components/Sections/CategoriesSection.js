  ...
  return (
    <div className='w-full flex flex-col gap-1 px-20 py-10'>
      <div className='flex flex-col gap-2 text-center' data-aos='zoom-out-up'>
        ...
        <h3 className='text-4xl font-bold'>Variety To Choose From</h3>
      </div>
      <div className='w-full flex gap-1 mt-12 text-white'>
        <div
          className='w-6/12 flex flex-col justify-center promo2 p-16 py-24 rounded-lg'
          data-aos='zoom-in'
          data-aos-delay='100'
        >
